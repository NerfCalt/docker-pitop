...
model_weights = 'yolov3.weights.1'
...
while True:
    ...
    if not any(output_layers):
        print("Nessun livello di output non connesso trovato.")
    else:
        output_names = [layer_names[i[0][0]] for i in output_layers]

        print("Nomi dei livelli di output:", output_names)
